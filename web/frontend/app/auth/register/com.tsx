        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <label
                className={`flex items-center justify-center h-12 rounded-xl border-2 cursor-pointer transition-all ${selectedRole === "client" ? "border-primary bg-primary/10" : "border-border hover:border-muted-foreground/30"}`}
              >
                <input
                  type="radio"
                  value="client"
                ...
                />
                <span
                  className={`text-sm font-medium ${selectedRole === "client" ? "text-primary font-bold" : "text-muted-foreground"}`}
                >
                  🛒 Cliente
                </span>
              </label>
              <label
                className={`flex items-center justify-center h-12 rounded-xl border-2 cursor-pointer transition-all ${selectedRole === "provider" ? "border-primary bg-primary/10" : "border-border hover:border-muted-foreground/30"}`}
              >
                <input
                  type="radio"
                  value="provider"
                ...
                />
                <span
                  className={`text-sm font-medium ${selectedRole === "provider" ? "text-primary font-bold" : "text-muted-foreground"}`}
                >
                  🔧 Prestador
                </span>
              </label>
