  ...
  return (
    <>
      ...
      <Dialog open={isCancelDialogOpen} onOpenChange={setIsCancelDialogOpen}>
        <DialogContent className="rounded-[2rem] border-border bg-card/95 backdrop-blur-xl">
          <DialogHeader>
            <DialogTitle>Cancelar Reserva</DialogTitle>
            <DialogDescription>
              Tens a certeza que desejas cancelar esta reserva? Os fundos serão
              reembolsados se aplicável.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4">
            <Input
              ...
              className="rounded-xl bg-muted/30 border-border h-12"
            />
          </div>
